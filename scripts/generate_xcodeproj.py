...
out.append("\t\t\t);")
out.append("\t\t\tdependencies = (")
out.append(f"\t\t\t\t{test_dep_uid} /* PBXTargetDependency */,")
out.append("\t\t\t);")
...
out.append(f"\t\t{test_proxy_uid} /* PBXContainerItemProxy */ = {{")
out.append("\t\t\tisa = PBXContainerItemProxy;")
out.append(f"\t\t\tcontainerPortal = {project_uid} /* Project object */;")
out.append("\t\t\tproxyType = 1;")
out.append(f"\t\t\tremoteGlobalIDString = {target_uid};")
out.append("\t\t\tremoteInfo = CFAL3;")
out.append("\t\t};")
...
out.append(f"\t\t\ttarget = {target_uid} /* CFAL3 */;")
out.append(f"\t\t\ttargetProxy = {test_proxy_uid} /* PBXContainerItemProxy */;")
out.append("\t\t};")
